...
const Register = () => {
  ...
  const firebaseError = (err) => {
    ...
    if (message.includes("auth/invalid-email")) return "Please provide a valid email address.";
  ...
  return (
    <div className="bg-cover bg-center bg-no-repeat py-24" style={{backgroundImage: `url(${formBg})`}}>
        <MyContainer>
      <div className="min-h-[80vh] flex justify-center items-center px-4">
        <div className="bg-white w-full max-w-md p-8 rounded-2xl shadow-lg border border-gray-100">
          ...
          <form onSubmit={handleRegister} className="space-y-5" noValidate>
            {/* Name */}
            <div>
              <label className="block font-medium text-[#19191B] mb-1">Name</label>
              <input
                type="text"
                name="name"
                required
            ...
            {/* Email */}
            <div>
              <label className="block font-medium text-[#19191B] mb-1">Email</label>
              <input
                type="email"
                name="email"
                required
            ...
            {/* Photo URL */}
            <div>
              <label className="block font-medium text-[#19191B] mb-1">Photo URL</label>
              <input
                type="text"
                name="photoURL"
                required
            ...
            {/* Password */}
            <div>
              <label className="block font-medium text-[#19191B] mb-1">Password</label>
              <input
                type="password"
                name="password"
                required
          ...
          >
            ...
            <span className="font-medium text-[#19191B]">Continue with Google</span>
          </button>

          {/* Login Link */}
          <p className="text-center text-sm text-gray-600 mt-6">
            Already have an account?{" "}
            <Link to="/login" className="text-[#e81c2e] hover:underline font-medium">
              Login
            </Link>
          </p>
        </div>
