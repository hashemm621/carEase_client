...
const CarsCard = ({car}) => {
  ...
  <div className="card-body">
    ...
    <div className="flex justify-between mb-2">
        <span className="badge bg-red-500 text-white font-semibold"><Car/> {categories} </span>
        <span className="badge bg-green-500 text-amber-400 font-semibold"><FaStar/> {rating} </span>
    </div>
    <p className="font-bold">Rent Per Day: ${pricePerDay} </p>
    <p className="font-bold">Location: <span className="text-lg text-red-400">{location}</span> </p>
